...
const teams = [
  ...
  { id: 2, name: 'Category Name', href: '#', initial: 'T', current: false },
  { id: 3, name: 'Category Name', href: '#', initial: 'W', current: false },
]
...
export default function Example({ children } : { children: React.ReactNode}) {
  ...
  const navigation = [
    ...
    { name: 'Products', href: '/admin/products', icon: ShoppingBagIcon, current: pathName === '/admin/products' },
    { name: 'Upcoming', href: '#', icon: FolderIcon, current: false },
